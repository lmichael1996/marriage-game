...
<body>
    ...
    <script>
        ...
        /**
         * Show edit set modal with pre-filled data
        ...
        function showEditSetModal(setId, name, description, questions) {
            ...
            if (actionInput) actionInput.value = 'update_set_with_questions';
        ...
        /**
         * Generate question fields based on number
         */
            ...
            if (num > currentCount) {
                for (let i = currentCount + 1; i <= num; i++) {
                    ...
                    questionDiv.innerHTML = `
                        ...
                        <div class="form-group">
                            <label>Tipo:</label>
                            <select name="type_${i}" class="question-type-select">
        ...
        /**
         * Update question type UI based on selected type
         * @param {number} index - Question index
         * @param {string} type - Question type (multiple, truefalse, clickfirst)
         */
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Question type change with event delegation
            const container = document.getElementById('questions-container');
            if (container) {

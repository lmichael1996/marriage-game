...
class RoomService {
    ...
    public function deleteRoom($roomCode) {
        ...
        // Purpose: mark the game as finished (create an end round)
        // and remove players, but keep the room row intact.
        try {
            ...
            // The winner will be set later when mark_winner is called.
            return [
                'success' => true,

...
INSERT INTO questions (question_set_id, round_number, round_type, question, option1, option2, option3, option4, correct_answer, timer) VALUES
(1, 1, 'multiple', 'Qual è l''animale più veloce del mondo?', 'Leone', 'Ghepardo', 'Leopardo', 'Tigre', 2, 10),
(1, 2, 'truefalse', 'I pinguini possono volare', 'Vero', 'Falso', '', '', 2, 10),
(1, 3, 'multiple', 'Qual è il mammifero più grande del mondo?', 'Elefante africano', 'Balenottera azzurra', 'Giraffa', 'Ippopotamo', 2, 10),
(1, 4, 'multiple', 'Quanti cuori ha il polpo?', '1', '2', '3', '5', 3, 10),
(1, 5, 'truefalse', 'Gli squali sono pesci', 'Vero', 'Falso', '', '', 1, 10),
(1, 6, 'multiple', 'Quale animale può dormire in piedi?', 'Mucca', 'Cavallo', 'Pecora', 'Tutti', 4, 10);
...
(2, 6, 'truefalse', 'La Gioconda non ha sopracciglia', 'Vero', 'Falso', '', '', 1, 10);
...
(3, 6, 'multiple', 'Quanto tempo impiega la luce del Sole a raggiungere la Terra?', '8 secondi', '8 minuti', '8 ore', '8 giorni', 2, 10);
...
(4, 5, 'multiple', 'Quale film di Tornatore ha vinto l''Oscar?', 'Malena', 'Cinema Paradiso', 'La leggenda del pianista', 'Baaria', 2, 10);
...
(5, 6, 'multiple', 'Quale città è famosa per il panettone?', 'Roma', 'Napoli', 'Milano', 'Torino', 3, 10);
...
(6, 6, 'truefalse', 'La Spagna ha una monarchia', 'Vero', 'Falso', '', '', 1, 10);
...
(7, 6, 'truefalse', 'L''Islanda si trova sopra il circolo polare artico', 'Vero', 'Falso', '', '', 2, 10);
...
(8, 6, 'multiple', 'Quanti pezzi ha ogni giocatore a Dama?', '10', '12', '15', '16', 2, 10);
...
(9, 6, 'truefalse', 'Voldemort ha paura della morte', 'Vero', 'Falso', '', '', 1, 10);
...
(10, 6, 'multiple', 'Chi inventò la stampa a caratteri mobili?', 'Galileo', 'Newton', 'Gutenberg', 'Leonardo', 3, 10);
...
(11, 6, 'truefalse', 'Pinocchio fu scritto da Collodi', 'Vero', 'Falso', '', '', 1, 10);
...
(12, 6, 'truefalse', 'Il numero Pi greco è infinito', 'Vero', 'Falso', '', '', 1, 10);
...
(13, 6, 'truefalse', 'Icaro volò troppo vicino al sole', 'Vero', 'Falso', '', '', 1, 10);
...
(14, 6, 'truefalse', 'Elvis Presley era chiamato "The King"', 'Vero', 'Falso', '', '', 1, 10);
...
(15, 6, 'truefalse', 'Gandhi era indiano', 'Vero', 'Falso', '', '', 1, 10);
...
(16, 6, 'truefalse', 'Lo sposo ha una sorella', 'Vero', 'Falso', '', '', 1, 10);
...
(17, 6, 'multiple', 'Quale gas respiriamo?', 'Ossigeno', 'Azoto', 'Anidride carbonica', 'Idrogeno', 1, 10);
...
(18, 6, 'truefalse', 'Il nuoto sincronizzato è uno sport olimpico', 'Vero', 'Falso', '', '', 1, 10);
...
(19, 6, 'truefalse', 'Mussolini fondò il fascismo', 'Vero', 'Falso', '', '', 1, 10);
...
(20, 6, 'truefalse', 'Fortnite è un gioco di strategia', 'Vero', 'Falso', '', '', 2, 10);
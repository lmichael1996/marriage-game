...
INSERT INTO
    question_sets (set_name, set_description)
VALUES
    (
        'Animali del Mondo',
        'Curiosità e fatti interessanti sugli animali'
    ),
    (
        'Arte e Pittura',
        'Grandi artisti e capolavori dell''arte'
    ),
    (
        'Astronomia',
        'Stelle, pianeti e misteri dell''universo'
    ),
    (
        'Cinema Italiano',
        'Film e registi del cinema italiano'
    ),
    (
        'Cucina Italiana',
        'Piatti tradizionali e ricette regionali'
    ),
    (
        'Geografia Europa',
        'Capitali, bandiere e luoghi d''Europa'
    ),
    (
        'Geografia Mondiale',
        'Paesi, continenti e geografia del mondo'
    ),
    (
        'Giochi da Tavolo',
        'Monopoly, Risiko e altri classici'
    ),
    (
        'Harry Potter',
        'Il mondo magico di J.K. Rowling'
    ),
    (
        'Invenzioni Storiche',
        'Scoperte che hanno cambiato il mondo'
    ),
    (
        'Letteratura Classica',
        'Grandi autori e opere letterarie'
    ),
    (
        'Matematica Base',
        'Operazioni e problemi matematici semplici'
    ),
    (
        'Mitologia Greca',
        'Dei, eroi e leggende dell''antica Grecia'
    ),
    (
        'Musica Pop',
        'Cantanti e band della musica pop mondiale'
    ),
    (
        'Personaggi Storici',
        'Grandi figure della storia mondiale'
    ),
    (
        'Quiz Matrimonio',
        'Domande divertenti per conoscere gli sposi'
    ),
    (
        'Scienze Naturali',
        'Biologia, chimica e fisica di base'
    ),
    (
        'Sport Olimpici',
        'Discipline, record e campioni olimpici'
    ),
    (
        'Storia Italiana',
        'Eventi e personaggi della storia d''Italia'
    ),
    (
        'Videogiochi',
        'Console, giochi e cultura videoludica'
    );
